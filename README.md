...
[![Test](https://github.com/teohrt/pdfcpu/workflows/Test/badge.svg)](https://github.com/teohrt/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/teohrt/pdfcpu?status.svg)](https://pkg.go.dev/github.com/teohrt/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/teohrt/pdfcpu)](https://goreportcard.com/report/github.com/teohrt/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/teohrt/pdfcpu/releases)
...
- For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/teohrt/pdfcpu/pkg/api).

### GoDoc

- [pdfcpu package](https://pkg.go.dev/github.com/teohrt/pdfcpu)
- [pdfcpu API](https://pkg.go.dev/github.com/teohrt/pdfcpu/pkg/api)
- [pdfcpu CLI](https://pkg.go.dev/github.com/teohrt/pdfcpu/pkg/cli)
...
Get the latest binary [here](https://github.com/teohrt/pdfcpu/releases).

### Using Go Modules

```
$ git clone https://github.com/teohrt/pdfcpu
...
```
$ go install github.com/teohrt/pdfcpu/cmd/pdfcpu@latest
```
...
- Please [create](https://github.com/teohrt/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
- Feature requests - always welcome!
- Bug fixes - always welcome!
- PRs - let's [discuss](https://github.com/teohrt/pdfcpu/discussions) first or [create](https://github.com/teohrt/pdfcpu/issues/new/choose) an issue.
- pdfcpu is stable but still _Alpha_ and occasionally undergoing heavy changes.

### How

- The pdfcpu [discussion board](https://github.com/teohrt/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
